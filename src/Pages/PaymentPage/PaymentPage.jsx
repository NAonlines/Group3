...
const PaymentPage = () => {
    ...
    useEffect(() => {
        const selectedDepartment = departments.find(dep => dep.value === parseInt(registrationData.department, 10));
                ...
                <div className="col-12 col-lg-9 col-xl-7">
                    <div className="card shadow mb-5 mt-5">
                        <div className="card-body p-4 p-md-5">
                            ...
                            <div className="row mb-3">
                                <div className="col-md-6">
                                    <strong>Address:</strong> {registrationData.address}, {registrationData.city}, {registrationData.states}, {registrationData.zipcode}, {registrationData.country}
                                </div>
                            </div>
                            <div className="row mb-3">
                                <div className="col-md-6">
                                    <strong>Insurance Name:</strong> {registrationData.insurancename}
                                </div>
                                <div className="col-md-6">
                            ...
                            <div className="row mb-3">
                                <div className="col-md-6">
                                    <strong>Pre-book:</strong> {registrationData.preBook ? 'Yes' : 'No'}
                                </div>
                                <div className="col-md-6">
                            ...
                            <div className="row mt-5 text-center">
                                <div className="col-md -6">
                                    <button className="btn btn-success btn-ms" onClick={handlePaymentClick}>
                                        Pay Now
                                    </button>
                                </div>
                            </div>
