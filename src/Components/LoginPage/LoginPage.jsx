  ...
  return (
    <div className="row login-page-overlay min-vh-100">
      <div
        ...
        className="row border rounded-5 p-3 bg-white shadow box-area col-md-8 login-container"
      >
        <div className="col-md-6 rounded-4 d-flex justify-content-center align-items-center flex-column left-box">
          <div className="featured-image mb-3">
            <img
              src={images.loginLogo}
              className="img-fluid login-logo-img"
              alt="Login Logo"
              style={{ width: "650px" }}
            />
          </div>
        ...
        <div className="col-md-6 right-box">
          <div className="row align-items-center">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <small>
                {loginError && (
                  <div className="text-danger small-text">{loginError}</div>
                )}
              </small>
              ...
              <div className="input-group mb-3">
                <button className="btn btn btn-outline-success w-50 fs-6">
                  Login
                </button>
                <button
                  type="button"
                  onClick={handleCancelClick}
                  className="btn btn btn-outline-danger w-50"
                >
                  Cancel
                </button>
              </div>
