...
function Footer() {
  return (
    <div className="footer shadow">
        ...
        <div className="row d-flex align-items-stretch">
          <div className="col-lg-4 text-center">
            <div className="container">
              <img
                className="img-logo-1 mb-4"
                src={images.logo}
                alt="Cambridge Hospital"
              />
              <p>
                Lorem ipsum dolor sit amet, lorem maximus consectetur adipiscing
              ...
              <div className="mt-5 coppyright-text d-none d-lg-block">
                <p className="mt-5">
                  Copyright FPT Aptech ©2023 All rights reserved{" "}
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="mt-5 coppyright-text d-lg-none fw-bold text-center">
        <p className="mt-5 ">
          Copyright FPT Aptech ©2023 All rights reserved{" "}
        </p>
      </div>
